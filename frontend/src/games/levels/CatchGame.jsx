...
function CatchGame({ onComplete }) {
  ...
  const finishGame = () => {
    ...
    // За каждое пойманное правильное даем 10 баллов
  ...
  if (!gameStarted) {
    return (
      <div className="catch-game">
        ...
        <p style={{color: '#44ff44', marginTop: '1rem'}}>💰 За каждый правильный предмет: <strong>10 баллов</strong></p>
      ...
      <div className="catch-game">
        ...
        <div style={{marginTop: '2rem'}}>
          <p style={{fontSize: '1.5rem', color: '#44ff44'}}>
            Ваш счет: <strong>{score * 10} баллов</strong>
          </p>
